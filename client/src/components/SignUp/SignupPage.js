    ...
    <div id={styles.signUpBody}>
      ...
      <div>
        ...
        <form id={styles.signUpform} name="signUpform" onSubmit={handleSubmit}>
          ...
          {userType === "Doctor" && <div className="form-floating mt-3 col-12 mx-2">
            <select
              id="location"
              name="location"
              value={location}
            ...
            >
              ...
              <option value="411027">Aundh</option>
              <option value="411038">Kothrud</option>
              <option value="411006">Wagholi</option>
              <option value="411016">Shivaji Nagar</option>
              {/* <option value="Nurse">Nurse</option> */}
            </select>
            <label htmlFor="userType">Location</label>
          </div>}
